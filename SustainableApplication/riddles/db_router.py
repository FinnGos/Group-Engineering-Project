class RiddleLocationRouter:
    """
    A database router to manage cross-database relations between Riddles (default DB) and Locations (location_db).
    """

    route_app_labels = {'riddles', 'Checkin'}
    ...
    def allow_relation(self, obj1, obj2, **hints):
        """
        Allow relations if a Riddle references a Location.
        """
        if obj1._meta.app_label in self.route_app_labels and obj2._meta.app_label in self.route_app_labels:
            return True  # Allow relations between Riddles and Checkin
    ...
    def allow_migrate(self, db, app_label, model_name=None, **hints):
        ...
        elif app_label == 'riddles':
            return db == 'default'  # Only migrate Riddle models in default DB
        return None
